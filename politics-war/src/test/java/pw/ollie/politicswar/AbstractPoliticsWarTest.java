...
import pw.ollie.politicswar.util.PoliticsWarEventCounter;
import pw.ollie.politicswar.util.PoliticsWarTestObjectFactory;

import java.util.Collections;

public abstract class AbstractPoliticsWarTest {
    ...
    protected Universe createDefaultUniverse() {
        ...
        UniverseRules defaultRules = PoliticsWarTestObjectFactory.newDefaultUniverseRules();
    ...
    protected PoliticsWarEventCounter registerEventCounter() {
        PoliticsWarEventCounter counter = new PoliticsWarEventCounter();
