...
import pw.ollie.politicstax.util.PoliticsTaxEventCounter;
import pw.ollie.politicstax.util.PoliticsTaxTestObjectFactory;

import java.util.Collections;

public abstract class AbstractPoliticsTaxTest {
    ...
    protected Universe createDefaultUniverse() {
        ...
        UniverseRules defaultRules = PoliticsTaxTestObjectFactory.newDefaultUniverseRules();
    ...
    protected PoliticsTaxEventCounter registerEventCounter() {
        PoliticsTaxEventCounter counter = new PoliticsTaxEventCounter();
