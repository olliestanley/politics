...
public class GroupSetSpawnCommand extends GroupSubCommand {
    ...
    public void runCommand(PoliticsPlugin plugin, CommandSender sender, Arguments args) throws CommandException {
        ...
        Plot plot = plugin.getPlotManager().getChunkPlotAt(rotatedPosition.getPosition().toLocation());
        if (plot == null) {
    ...
    public String getUsage() {
        return "/" + groupLevel.getName() + " setspawn [-p player] [-g " + groupLevel.getName() + "] [-u universe]";
    }
