...
import net.oliverstanley.politics.util.math.Vector3i;
 ...
 */
public final class Subplot implements ProtectedRegionCuboid {
    ...
    public Stream<Privilege> playerPrivileges(UUID playerId) {
